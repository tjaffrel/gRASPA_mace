...
struct MACE
{
  ...
  double Predict()
  {
    ...
    // Assume Z-Table is: H(1), C(6), N(7), O(8), F(9), P(15), S(16), Cl(17), Br(35), I(53) (from mock output)
    // [1, 6, 7, 8, 9, 15, 16, 17, 35, 53]
    std::vector<int> ModelZTable = {1, 6, 7, 8, 9, 15, 16, 17, 35, 53};
    int num_species = ModelZTable.size();
